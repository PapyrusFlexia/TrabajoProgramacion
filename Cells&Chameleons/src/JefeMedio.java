...
public class JefeMedio extends JFrame {
	...
	int VidaTotal = Dado.tirarDado(6) + 2;
	...
	/** igual que la creacion de personajes pero con jefes medios y lo añade a la base de datos **/
	...
	public JefeMedio() {
		...
		btnCrear.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				AddBaseDeDatos(textFieldid.getText(), textField.getText(), VidaTotal, atkInicial, VidaTotal); 
	...
	/**
	 * SE INSERTA EN LA BASE DE DATOS LOS DATOS DEL JEFE
	 * @param id
	 * @param nombre
	 * @param vida
	 * @param ataque
