...
public class AddArmaduras extends JFrame {
	...
	public static void AddBaseDeDatos(String nombre, String vida, String valor, String tipo) {
		Conexion.conectar();
		
		
		Conexion.EjecutarUpdate("INSERT INTO armadura VALUES (\""+ nombre + "\", " + vida + ", " + valor + ", \"" + tipo + "\");");
	}
}