...
public class JefeDificil extends JFrame {
	...
	public JefeDificil() {
		...
		JLabel label_2 = new JLabel("1d16");
		...
		btndD20.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				JOptionPane.showMessageDialog(dado.getComponent(0), "Has sacado un " + VidaDificil); ///////// VIDATOTAL
				vidatotalfield.setText("El JEFE tiene " + VidaDificil + " de vida total");
				vidaActual.setText("El JEFE tiene " + VidaDificil+ " de vida actual");
